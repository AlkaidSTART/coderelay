...
export const AgentConfigSchema = z.object({
  ...
  /** Override the binary, e.g. `/opt/homebrew/bin/codex`. */
  command: z.string().optional(),
  /** Models exposed by this agent; empty means "adapter defaults". */
...
export const RuleWhenSchema = z.object({
  ...
  patterns: z.array(z.string().refine(isRegExp, "must be a valid regular expression")).optional(),
